...
<div class="db-stats mb-4">
    ...
    <div class="db-sc ac-amber">
        <div class="sc-inner">
            ...
            <div class="sc-val db-counter" data-target="{{ $stats['pending_orders'] }}">{{ $stats['pending_orders'] }}</div>
            <div class="sc-foot">
    ...
    <div class="db-sc ac-blue">
        <div class="sc-inner">
            ...
            <div class="sc-val db-counter" data-target="{{ $stats['total_orders'] }}">{{ $stats['total_orders'] }}</div>
            <div class="sc-foot">
    ...
    <div class="db-sc ac-cyan">
        <div class="sc-inner">
            ...
            <div class="sc-val db-counter" data-target="{{ $stats['total_reservations'] }}">{{ $stats['total_reservations'] }}</div>
            <div class="sc-foot">
    ...
    <div class="db-sc ac-violet">
        <div class="sc-inner">
            ...
            <div class="sc-val db-counter" data-target="{{ $stats['total_menu_items'] }}">{{ $stats['total_menu_items'] }}</div>
            <div class="sc-foot">
    ...
    <div class="db-sc ac-rose">
        <div class="sc-inner">
            ...
            <div class="sc-val db-counter" data-target="{{ $stats['total_users'] }}">{{ $stats['total_users'] }}</div>
            <div class="sc-foot">
    ...
    <div class="col-lg-7 mb-3 mb-lg-0">
        <div class="db-panel" style="animation-delay:.16s">
            <div class="db-ph ph-blue">
                ...
                <a href="{{ route('admin.orders.index') }}" class="db-view-all">View All <i class="fas fa-arrow-right"></i></a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center" style="gap:8px">
                                    <span class="db-avatar" style="background:linear-gradient(135deg,hsl({{$h}},52%,46%),hsl({{$h2}},52%,36%))">{{ strtoupper(substr($order->user->name ?? 'G',0,1)) }}</span>
                                    <span class="db-cname">{{ $order->user->name ?? 'Guest' }}</span>
                                </div>
                            </td>
                            <td>
                                @if($order->table)
                                    <span class="db-chip chip-dine"><i class="fas fa-chair"></i> T#{{ $order->table->table_number }}</span>
                                @else
                                    <span class="db-chip chip-take"><i class="fas fa-shopping-bag"></i> Takeaway</span>
                                @endif
                            </td>
                            <td><span class="db-amount">Rs.&nbsp;{{ number_format($order->total_amount,0) }}</span></td>
                            <td>
    ...
    <div class="col-lg-5">
        <div class="db-panel" style="animation-delay:.22s">
            <div class="db-ph ph-teal">
                ...
                <a href="{{ route('admin.reservations.index') }}" class="db-view-all">View All <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="table-responsive">
                <table class="db-tbl">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center" style="gap:8px">
                                    <span class="db-avatar" style="background:linear-gradient(135deg,hsl({{$gh}},52%,46%),hsl({{$gh2}},52%,36%))">{{ strtoupper(substr($res->guest_name,0,1)) }}</span>
                                    <div>
                                        <div class="db-gname">{{ $res->guest_name }}</div>
                                        <div class="db-gsub"><i class="fas fa-phone" style="font-size:.55rem"></i> {{ $res->guest_phone }}</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="db-dMain"><i class="fas fa-calendar" style="color:#3b82f6;font-size:.65rem"></i> {{ \Carbon\Carbon::parse($res->reservation_date)->format('d M Y') }}</div>
                                <div class="db-dSub"><i class="fas fa-clock" style="font-size:.58rem"></i> {{ $res->reservation_time }}</div>
                            </td>
                            <td>
...
<div class="db-qa">
    ...
    <div class="db-qa-body">
        <a href="{{ route('admin.categories.create') }}"  class="db-qa-btn qa-blue">    <i class="fas fa-layer-group"></i>    Add Category</a>
        <a href="{{ route('admin.menu.create') }}"        class="db-qa-btn qa-emerald"> <i class="fas fa-utensils"></i>       Add Menu Item</a>
        <a href="{{ route('admin.tables.create') }}"      class="db-qa-btn qa-cyan">    <i class="fas fa-chair"></i>          Add Table</a>
        <a href="{{ route('admin.orders.index') }}"       class="db-qa-btn qa-amber">   <i class="fas fa-receipt"></i>        View Orders</a>
        <a href="{{ route('admin.reservations.index') }}" class="db-qa-btn qa-rose">    <i class="fas fa-calendar-check"></i> View Reservations</a>
    </div>
</div>
