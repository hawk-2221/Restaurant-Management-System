...
<style>
    ...
    .menu-form-wrapper {
        ...
        --input-focus-shadow: rgba(246, 194, 62, 0.12);
        --text-primary: #2c3e50;
        --text-secondary: #6c757d;
        --text-muted: #858796;
        --gradient-primary: linear-gradient(135deg, #f6c23e 0%, #f4a460 100%);
    ...
    html[data-color-mode="dark"] .menu-form-wrapper {
        ...
        --input-focus-shadow: rgba(251, 191, 36, 0.15);
        --text-primary: #f1f5f9;
    ...
    .current-image-wrapper {
        background: var(--current-image-bg);
        border: 2px solid var(--input-border);
        border-radius: 18px;
        padding: 1.5rem;
    ...
    @keyframes pulse {
        ...
        50% {
            box-shadow: 0 0 0 25px rgba(246, 194, 62, 0);
        }
    }
    ...
    .btn-update {
        background: var(--gradient-primary);
        color: white;
        box-shadow: 0 10px 25px rgba(246, 194, 62, 0.45);
    }

    .btn-update:hover {
        box-shadow: 0 15px 35px rgba(246, 194, 62, 0.55);
    }
                ...
                <div class="header-content">
                    <div class="header-title">
                        ...
                        <div class="header-text">
                            ...
                            <p>Update details for: {{ $menu->name }}</p>
                        </div>
                    </div>
            ...
            <form method="POST"
                ...
                <div class="form-content">
                    ...
                    <div class="form-section-left">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" 
                                      ...
                                      maxlength="500"
                                      id="descriptionArea">{{ old('description', $menu->description) }}</textarea>
                            <span class="char-counter" id="charCounter">{{ strlen($menu->description) }} / 500</span>
                        </div>
                    ...
                    <div class="form-section-right">
                        ...
                        <div class="file-upload-zone" id="uploadZone">
                            ...
                            <div class="upload-text">
                                <h5>{{ $menu->image ? 'Upload New Image' : 'Upload Image' }}</h5>
                                <p>{{ $menu->image ? 'Replace current image with a new one' : 'Upload a high-quality image' }}</p>
                            </div>
                        ...
                        <div class="tips-box">
                            ...
                            <p>
                                ...
                                @else
                                    Upload a high-quality image to showcase your menu item.
                                @endif
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-modern btn-update" id="submitBtn">
        ...
        imagePreview.innerHTML = `
            <div class="preview-container">
                ...
                <span class="preview-badge">
                    <i class="fas fa-check"></i> New Image
                </span>
...
document.getElementById('menuForm').addEventListener('submit', function(e) {
    ...
    submitBtn.innerHTML = '<span style="visibility:hidden;">Updating...</span>';
